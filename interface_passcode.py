...
layout = [
    [sg.Text("iForge 3D Print System", font=("Helvetica", 12))],
...
def main(passcode):
    ...
    window = sg.Window("iForge Passcode", element_justification="center", enable_close_attempted_event=True)
    ...
    while True:
        ...
        if event == "Clear":
            ...
            if passcode_input == passcode:
                # form["-output_text-"]("SUCCESS", text_color="lightgreen")
                return_value = True
                break
            else:
